...
ADD *.ml *.mli dune* /home/opam/tawhiri-downloader/
WORKDIR /home/opam/tawhiri-downloader

RUN opam init -y
RUN eval $(opam env) && opam install "core=v0.14.1" async ctypes ctypes-foreign ocurl dune && dune build --profile=release main.exe
